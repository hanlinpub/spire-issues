...
{
    public class DocxUpdateTableOfContentsConcurrencyTests
    {
        private readonly ITestOutputHelper _outputHelper;

        public DocxUpdateTableOfContentsConcurrencyTests(ITestOutputHelper outputHelper)
        {
        ...
        public void SingleThread_WithoutFullwidthSymbol_IsOk()
        {
            try
            {
                using var doc = new Document("inputs/OkTemplate.docx");
        ...
        public void SingleThread_WithFullwidthSymbol_IsOk()
        {
            try
            {
                using var doc = new Document("inputs/ErrorTemplate.docx");
                doc.UpdateTableOfContents();
            }
            catch (Exception e)
            {
